                  ...
                  >
                    {selectedProduct.imageUrl ? (
                      <img
                        ...
                        //     console.log(
                        //       "Already using placeholder, stopping error handling"
                        //     );
                        //     return;
                        //   }
                        ...
                        //     if (filename) {
                        //       console.log(
                        //         "Trying with /images/products/ path for filename:",
                        //         filename
                        //       );
                        ...
                        //     console.log(
                        //       "Image with correct path still failing, trying uploads directory"
                        //     );
                        //     const filename = selectedProduct
                        //       ?.imageUrl!.split("/")
                        //       .pop();
